return {
  ...
  ["misc"] = {
    ...
    ["v_text"] = {
      ...
      ["ch_c_all_eternal"] = {
        [1] = "All Jimbos are {C:eternal}Eternal{}",
      },
      ["ch_m_none"] = {
        [1] = "{C:inactive}None",
      },
      ...
      ["ch_c_set_eternal_ante"] = {
        [1] = "When ante {C:attention}#1#{} boss is defeated, all Jimbos become {C:attention}eternal",
      },
      ...
      ["ch_c_set_joker_slots_ante"] = {
        [1] = "When ante {C:attention}#1#{} boss is defeated, set Jimbo slots to {C:attention}0",
      },
      ["ch_c_daily"] = {
      ...
      ["ch_c_no_shop_jokers"] = {
        [1] = "Jimbos no longer appear in the {C:attention}shop",
      },
    ...
    ["quips"] = {
      ...
      ["wq_6"] = {
        [1] = "Look at all that {C:gold}Muhniee!{}",
        [2] = "heads up plays!",
      },
    },
    ...
    ["tutorial"] = {
      ...
      ["s_3"] = {
        ...
        [2] = "{C:attention}Jimbos{} you can add to",
        [3] = "your run. Every {C:attention}Jimbo",
      ...
      ["sh_1"] = {
        ...
        [3] = "them. {C:attention}Jimbos{} trigger in",
      ...
      ["s_2_touch"] = {
        [1] = "Try buying this",
        [2] = "handsome Devil!",
        [3] = "Drag it from the shop",
        [4] = "into the {C:attention}'BUY'{} area",
      },
      ["sb_3"] = {
      ...
      ["sh_3_touch"] = {
        [1] = "Select up to {C:attention}2{} cards",
        [2] = "in your hand and drag",
        [3] = "the {C:tarot}Tarot{} card into the {C:attention}'USE'{}",
        [4] = "area to enhance them!",
      },
      ["sb_2"] = {
      ...
      ["s_5"] = {
        ...
        [2] = "carry {C:attention}5 Jimbo{} cards",
        [3] = "at a time",
      },
    },
    ["achievement_names"] = {
    ...
    ["dictionary"] = {
      ...
      ["ml_controller_required"] = {
        [1] = "A game controller is required to play.",
        [2] = "Please connect a controller to continue.",
      },
      ...
      ["k_eroded_ex"] = "Eroded!",
      ["ml_offline_message"] = {
        [1] = "This device is offline.",
        [2] = "The current save may be out of date.",
      },
      ["k_tarot"] = "Tarot",
  ...
  ["descriptions"] = {
    ...
    ["Tag"] = {
      ...
      ["tag_negative"] = {
        ...
        ["text"] = {
          ...
          [2] = "Jimbo is free and",
          [3] = "becomes {C:dark_edition}Negative",
        },
      },
      ["tag_investment"] = {
        ["name"] = "Investment Tag",
      ...
      ["tag_holo"] = {
        ...
        ["text"] = {
          [1] = "Next base edition shop",
          [2] = "Jimbo is free and",
          [3] = "becomes {C:dark_edition}Holographic",
        },
      },
      ["tag_rare"] = {
        ["name"] = "Rare Tag",
      ...
      ["tag_polychrome"] = {
        ...
        ["text"] = {
          [1] = "Next base edition shop",
          [2] = "Jimbo is free and",
          [3] = "becomes {C:dark_edition}Polychrome",
        },
      },
      ["tag_juggle"] = {
        ["name"] = "Juggle Tag",
    ...
    ["Tarot"] = {
      ...
      ["c_wheel_of_fortune"] = {
        ...
        ["text"] = {
          ...
          [4] = "to a random {C:attention}Jimbo",
        },
      },
      ["c_heirophant"] = {
        ["name"] = "The Hierophant",
      ...
      ["c_temperance"] = {
        ...
        ["text"] = {
          ...
          [3] = "Jimbos {C:inactive}(Max of {C:money}$#1#{C:inactive})",
    ...
    ["Stake"] = {
      ...
      ["stake_gold"] = {
        ["name"] = "Gold Stake",
        ["text"] = {
          [1] = "Shop can have {C:attention}Rental{} Jimbos",
          [2] = "{C:inactive,s:0.8}(Costs {C:money,s:0.8}$3{C:inactive,s:0.8} per round)",
          [3] = "{s:0.8}Applies all previous Stakes",
        },
      },
      ["stake_white"] = {
      ...
      ["stake_orange"] = {
        ["name"] = "Orange Stake",
        ["text"] = {
          [1] = "Shop can have {C:attention}Perishable{} Jimbos",
          [2] = "{C:inactive,s:0.8}(Debuffed after 5 Rounds)",
          [3] = "{s:0.8}Applies all previous Stakes",
        },
      },
      ["stake_black"] = {
        ["name"] = "Black Stake",
        ["text"] = {
          [1] = "Shop can have {C:attention}Eternal{} Jimbos",
    ...
    ["Other"] = {
      ["p_buffoon_jumbo"] = {
        ...
        ["text"] = {
          ...
          [2] = "{C:attention}#2#{C:joker} Jimbo{} cards",
        },
      },
      ["p_standard_jumbo"] = {
      ...
      ["perishable"] = {
        ...
        ["text"] = {
          ...
          [3] = "{C:inactive}({C:attention}#2#{C:inactive} remaining)",
        },
      },
      ["blue_seal"] = {
        ["name"] = "Blue Seal",
        ["text"] = {
          [1] = "Creates the {C:planet}Planet{} card",
          [2] = "for final played {C:attention}poker hand{}",
          [3] = "of round if {C:attention}held{} in hand",
    ...
    ["Joker"] = {
      ...
      ["j_supernova"] = {
        ["name"] = "Supernova",
        ["text"] = {
          [1] = "Adds the number of times",
          [2] = "{C:attention}poker hand{} has been",
          [3] = "played this run to Mult",
        },
      },
      ["j_droll"] = {
        ["name"] = "Droll Jimbo",
      ...
      ["j_castle"] = {
        ["name"] = "Castle",
        ["text"] = {
          [1] = "This Jimbo gains {C:chips}+#1#{} Chips",
      ...
      ["j_shortcut"] = {
        ...
        ["text"] = {
          ...
          [3] = "{C:inactive}(ex: {C:attention}10 8 6 5 3{C:inactive})",
        },
      },
      ["j_luchador"] = {
        ["name"] = "Nacho Libre",
      ...
      ["j_rocket"] = {
        ...
        ["text"] = {
          ...
          [2] = "Payout increases by {C:money}$#2#{}",
      ...
      ["j_hologram"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains {X:mult,C:white} X#1# {} Mult",
          [2] = "every time a {C:attention}playing card{}",
          [3] = "is added to your deck",
          [4] = "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
        },
      },
      ["j_ride_the_bus"] = {
        ["name"] = "Ride the Bus",
        ["text"] = {
          [1] = "This Jimbo gains {C:mult}+#1#{} Mult",
      ...
      ["j_square"] = {
        ["name"] = "Square Jimbo",
        ["text"] = {
          [1] = "This Jimbo gains {C:chips}+#2#{} Chips",
          [2] = "if played hand has",
      ...
      ["j_yorick"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains",
          [2] = "{X:mult,C:white} X#1# {} Mult every {C:attention}#2#{C:inactive} [#3#]{}",
          [3] = "cards discarded",
          [4] = "{C:inactive}(Currently {X:mult,C:white} X#4# {C:inactive} Mult)",
        },
      },
      ["j_gift"] = {
        ["name"] = "Gift Card",
        ["text"] = {
          ...
          [2] = "to every {C:attention}Jimbo{} and",
      ...
      ["j_lucky_cat"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains {X:mult,C:white} X#1# {} Mult",
          [2] = "every time a {C:attention}Lucky{} card",
      ...
      ["j_invisible"] = {
        ["unlock"] = {
          [1] = "Win a run without",
          [2] = "ever having more",
          [3] = "than {E:1,C:attention}4 Jimbos{}",
        },
        ["name"] = "John Cena",
        ["text"] = {
          [1] = "After {C:attention}#1#{} rounds,",
          [2] = "sell this card to",
          [3] = "{C:attention}Duplicate{} a random Jimbo",
      ...
      ["j_flower_pot"] = {
        ...
        ["name"] = "Flower Pot",
        ["text"] = {
          [1] = "{X:mult,C:white} X#1# {} Mult if poker",
          [2] = "hand contains a",
      ...
      ["j_8_ball"] = {
        ...
        ["text"] = {
          ...
          [2] = "played {C:attention}8{} to create a",
          [3] = "{C:tarot}Tarot{} card when scored",
          [4] = "{C:inactive}(Must have room)",
        },
      },
      ["j_hallucination"] = {
      ...
      ["j_riff_raff"] = {
        ...
        ["text"] = {
          [1] = "When {C:attention}Blind{} is selected,",
          [2] = "create {C:attention}#1# {C:blue}Common{C:attention} Jimbos",
          [3] = "{C:inactive}(Must have room)",
        },
      },
      ["j_superposition"] = {
      ...
      ["j_swashbuckler"] = {
        ["unlock"] = {
          [1] = "Sell a total of",
          [2] = "{C:attention,E:1}#1#{} Jimbo cards",
          [3] = "{C:inactive}(#2#)",
        },
        ["name"] = "Swashbonkler",
        ["text"] = {
          [1] = "Adds the sell value",
          [2] = "of all other owned",
          [3] = "{C:attention}Jimbos{} to Mult",
      ...
      ["j_constellation"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains",
          [2] = "{X:mult,C:white} X#1# {} Mult every time",
          [3] = "a {C:planet}Planet{} card is used",
          [4] = "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
        },
      },
      ["j_selzer"] = {
      ...
      ["j_stone"] = {
        ["name"] = "Stone Jimbo",
        ["text"] = {
          [1] = "Gives {C:chips}+#1#{} Chips for",
          [2] = "each {C:attention}Stone Card",
      ...
      ["j_raised_fist"] = {
        ...
        ["text"] = {
          ...
          [2] = "of {C:attention}lowest{} ranked card",
          [3] = "held in hand to Mult",
        },
      },
      ["j_marble"] = {
        ["name"] = "Marble Jimbo",
      ...
      ["j_caino"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains {X:mult,C:white} X#1# {} Mult",
          [2] = "when a {C:attention}face{} card",
          [3] = "is destroyed",
          [4] = "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
        },
      },
      ...
      ["j_drivers_license"] = {
        ...
        ["text"] = {
          [1] = "{X:mult,C:white} X#1# {} Mult if you have",
          [2] = "at least {C:attention}16{} Enhanced",
          [3] = "cards in your full deck",
      ...
      ["j_stencil"] = {
        ...
        ["text"] = {
          ...
          [2] = "empty {C:attention}Jimbo{} slot",
          [3] = "{s:0.8}Stencil included",
      ...
      ["j_madness"] = {
        ["name"] = "Madness",
        ["text"] = {
          [1] = "When {C:attention}Small Blind{} or {C:attention}Big Blind{}",
          [2] = "is selected, gain {X:mult,C:white} X#1# {} Mult",
          [3] = "and {C:attention}destroy{} a random Jimbo",
          [4] = "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
        },
      },
      ["j_family"] = {
      ...
      ["j_bootstraps"] = {
        ["unlock"] = {
          [1] = "Have at least {E:1,C:attention}#1#",
          [2] = "{C:dark_edition}Polychrome{} Jimbos",
        },
        ["name"] = "Bootstraps",
        ["text"] = {
      ...
      ["j_ring_master"] = {
        ...
        ["name"] = "Showman",
        ["text"] = {
          [1] = "{C:attention}Jimbo{}, {C:tarot}Tarot{}, {C:planet}Planet{},",
      ...
      ["j_vampire"] = {
        ...
        ["text"] = {
          [1] = "This Jimbo gains {X:mult,C:white} X#1# {} Mult",
          [2] = "per scoring {C:attention}Enhanced card{} played,",
      ...
      ["j_hanging_chad"] = {
        ...
        ["text"] = {
          ...
          [3] = "{C:attention}#1#{} additional times",
        },
      },
      ["j_even_steven"] = {
        ["name"] = "Even Steven",
    ...
    ["Spectral"] = {
      ["c_ankh"] = {
        ...
        ["text"] = {
          ...
          [2] = "random {C:attention}Jimbo{}, destroy",
          [3] = "all other Jimbos",
        },
      },
      ["c_cryptid"] = {
    ...
    ["Voucher"] = {
      ...
      ["v_glow_up"] = {
        ["unlock"] = {
          [1] = "Have at least {C:attention}#1#",
          [2] = "{C:attention}Jimbo{} cards with",
